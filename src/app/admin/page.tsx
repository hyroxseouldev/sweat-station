    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            <div className="mb-6">
              <h2 className="text-lg font-semibold text-gray-800 mb-2">사용자 정보</h2>
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600">이메일: <span className="font-medium text-gray-800">{user.email}</span></p>
                <p className="text-sm text-gray-600 mt-1">사용자 ID: <span className="font-medium text-gray-800">{user.id}</span></p>
                <p className="text-sm text-gray-600 mt-1">마지막 로그인: <span className="font-medium text-gray-800">{new Date(user.last_sign_in_at || '').toLocaleString('ko-KR')}</span></p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-800">데이터 분석</h3>
              ...
              <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-800">시스템 설정</h3>
